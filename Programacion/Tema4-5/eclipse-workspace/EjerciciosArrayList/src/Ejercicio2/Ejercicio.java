...
public class Ejercicio {
	...
	while(seguir!=false) {	
		...
		case 4:
			...
			for(int i=0;i<cochesAlmacenados.size();i++) {
				Coche cocheVariable=cochesAlmacenados.get(i);
				System.out.println("Matricula:"+cocheVariable.getMatricula()+" Marca:"+cocheVariable.getMarca());	
				System.out.println("Modelo:"+cocheVariable.getModelo()+" Kilometros coche:"+cocheVariable.getKilometros());
				System.out.println("");
			}
			break;
			}
		case 5:
			...
			Introducir.nextLine();
			System.out.println("Introduce la marca de los coches que quieres mostrar:");
			String marcaMostr=Introducir.nextLine();
			for(int i=0;i<cochesAlmacenados.size();i++) {
				Coche cocheVariable=cochesAlmacenados.get(i);
				if(cocheVariable.getMarca().equals(marcaMostr)) {
					System.out.println("Matricula:"+cocheVariable.getMatricula()+" Marca:"+cocheVariable.getMarca());	
					System.out.println("Modelo:"+cocheVariable.getModelo()+" Kilometros coche:"+cocheVariable.getKilometros());
				    System.out.println("");
				}
